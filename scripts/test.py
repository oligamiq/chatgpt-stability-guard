...
def main():
    ...
    run(sys.executable, 'scripts/test_recent_window_property.py')
    run(sys.executable, 'scripts/test_recent_window_stress.py')
    run(sys.executable, 'scripts/test_recent_window_performance.py')
    run(sys.executable, 'scripts/test_recent_n_normalization.py')

...
def main():
    ...
    required = {
        'active': {'stop', 'shellMeasurableOffFlow', 'rowLive', 'previewLive', 'retry'},
    ...
    print('PASS generation-completion: live summary shell stays measurable off-flow while App preview remains measurable')
